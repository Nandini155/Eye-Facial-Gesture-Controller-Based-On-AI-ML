...
sub_heading.place(relx=.5,rely=.3,anchor="center")

sub_heading = Label(frame,text="To dive in click the button below!",fg="#57a1f8",bg='white',font=('Microsoft YaHei UI Light',15,'bold'))
sub_heading.place(relx=.5,rely=.5,anchor="center")

img2 = PhotoImage(file = resource_path('nextbtn.png'))
next_btn = Button(frame,image=img2,border=0,bg='white',cursor='hand2',command=tovideoui)
